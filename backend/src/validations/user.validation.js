...
const domainEmailValidator = (value, helper) => {
    if (!value.endsWith('@alumnos.ubiobio.cl')) {
        return helper.message("El correo electrónico debe ser del dominio @alumnos.ubiobio.cl");
    }
    return value;
};
...
export const userQueryValidation = Joi.object({
    ...
    email: Joi.string()
        ...
        .messages({
            ...
            "string.email": "El correo electrónico debe tener un formato válido y finalizar en @alumnos.ubiobio.cl.",
            "string.min": "El correo electrónico debe tener como mínimo 20 caracteres.",
            "string.max": "El correo electrónico debe tener como máximo 36 caracteres."
        })
...
export const userBodyValidation = Joi.object({
    ...
    email: Joi.string()
        ...
        .messages({
            ...
            "string.min": "El correo electrónico debe tener como mínimo 17 caracteres.",
            "string.max": "El correo electrónico debe tener como máximo 30 caracteres."
        })
        .custom(domainEmailValidator, 'Validación dominio email'),
    password: Joi.string()
        .min(3)
